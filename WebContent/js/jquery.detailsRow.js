...
$.fn.detailsRow = function(url,options){
	...
	// alter the DOM
	var $headerIndicator = $("<th class='"+settings.indicatorClass+"' title=''>"+settings.headerIndicator+"</th>").click(_toggleAll);
	...
	function _toggleAll(){
	//	$('td.'+settings.indicatorClass,selectedElement).clicked() //show all
	};
