...
/**
 * @classDescription Periodically performs an AJAX request and updates a container抯 contents based on the response text. Offers a mechanism for 揹ecay,�which lets it trigger at widening intervals while the response is unchanged.
...
Element.Methods = {
  ...
  */
  ...
  /**
   * Collects all of the element抯 immediate descendants (i.e. children) and returns them as an array of extended elements.
  ...
  /**
   * Returns element抯 first descendant (or the n-th descendant if index is specified) that matches cssRule. If no cssRule is provided, all descendants are considered. If no descendant matches these criteria, undefined is returned.
   * @alias Element.down
   * @param {Element} element	Element to match
   * @param {String} [expression]	cssRule to match
...
Form.Methods = {
  ...
  */
  ...
  /**
   * A convenience method for serializing and submitting the form via an Ajax.Request to the URL of the form抯 action attribute. The options parameter is passed to the Ajax.Request instance, allowing to override the HTTP method and to specify additional parameters.
   * @alias Form.request
