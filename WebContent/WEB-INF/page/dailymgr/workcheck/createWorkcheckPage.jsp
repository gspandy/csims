...
<html>
	...
	function createWorkcheck(){
		if(confirm("操作将新增工作检查信息,确认?")){
			document.forms[0].action="DailyMgrAction.do?method=createWorkcheck";
	...
	<body>
		...
		<html:form action="/DailyMgrAction.do?method=createWorkcheck"
			method="post">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
																...
																<tr>
																	<td colspan="2" align="center">
																		<input type="button" value="保 存" class="botton01"
																			onclick="return createWorkcheck();" />
