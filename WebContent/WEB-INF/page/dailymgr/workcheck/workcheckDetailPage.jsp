...
<html>
	...
	<body>
		...
		<html:form action="/DailyMgrAction.do?method=toWorkcheckDetailPage" method="post">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
														...
														<td height="180" valign="top">
															<table width="100%" border="0" cellpadding="0"
																...
																<tr>
																	...
																	<td>
																	<html:text property="chkorgnm"  readonly="true" size="100%"></html:text>
																	</td>
																</tr>
																<tr>
																	<td align="right" class="tabletext02">
																	...
																	<td>
																		<html:text property="chkorgtele" readonly="true" size="100%"></html:text>
																	</td>
																</tr>
																<tr>
																	<td align="right" class="tabletext02">
																	...
																	<html:text property="chkedorgnm"  readonly="true" size="100%"></html:text>
																	</td>
																</tr>
																<tr>
																	<td align="right" class="tabletext02">
																	...
																	<td class="tdstylebotton">
																	<html:text property="chkedorgno"  readonly="true" size="100%"></html:text>
																	</td>
																</tr>
																<tr>
                                                                    <td align="right" class="tabletext02">
																...
																<tr>
																	...
																	<td>
																		<html:text property="chkstartdt" readonly="true" />
																		至&nbsp;&nbsp;&nbsp;
																		<html:text property="chkenddt" readonly="true" />
																	</td>
																</tr>
																<tr>
																	<td align="right" class="tabletext02">
																	...
																	<td>
																		<html:textarea property="chkcont" cols="140%"
																			rows="5" readonly="true"></html:textarea>
																	</td>
																</tr>
																<tr>
