...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function updateAerectification(){
			  if(validateForm()){
				Ext.Msg.confirm('提示', '是否确认修改跟踪整改信息?' , function(btn) {
                    if(btn == 'yes') {
                        var msgbox = Ext.Msg.progress("提示","保存数据","请稍候....."); //显示等待对话框 
                        document.forms[0].action="AdminEnforceManagerAction.do?method=updateAerectification";
	...
	<body>
		...
		<html:form
			action="/AdminEnforceManagerAction.do?method=updateAerectification"
			method="post">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
																...
																<tr>
																	<td colspan="2" align="center">
																		<input type="button" value="保 存" class="botton01"
																			onclick="return updateAerectification();" />
