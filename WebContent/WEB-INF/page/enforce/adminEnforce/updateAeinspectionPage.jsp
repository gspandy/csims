...
function updateAeinspection() {
    if(validateForm()) {
        Ext.Msg.confirm('提示', '是否确认修改检查工作记录信息?', function(btn) {
            if(btn == 'yes') {
                var msgbox = Ext.Msg.progress("提示", "保存数据", "请稍候.....");
                document.forms[0].action = "AdminEnforceManagerAction.do?method=updateAeinspection";
    ...
    var row1 = {
        ...
        items : [{
            ...
            items : [{
                xtype : 'textfield',
                fieldLabel : '被检查人',
                value: $("input[name='aeedorgnm']").val(),
                name : 'field1',
                id : 'field1',
                width : 250,
                allowBlank : false
    ...
    var row2 = {
        ...
        items : [{
            ...
            items : [{
                ...
                name : 'field3',
                id : 'field3',
                value : $("input[name='aeheadman']").val(),
                width : 250,
                allowBlank : false
            }]
        }, {
            ...
            handler : function() {
                Ext.Msg.confirm('提示', '是否确认新增工作底稿？', function(btn) {
                    if(btn == 'yes') {
                        //FormPanel自身带异步提交方式
                        fp.getForm().submit({
                            url : '<%=request.getContextPath()%>/AdminEnforceManagerAction.do?method=saveBasisAtUpdateInspc',
                            waitTitle : '请等待',
                            waitMsg : '正在添加工作底稿',
...
function viewBasisGrid() {
	...
	var viewFiled5From = new Ext.form.FormPanel({
	...
	var viewBasisWin = new Ext.Window({
		...
		buttons : [{
			...
			handler : function() {
				...
				Ext.Msg.confirm('提示', '是否确认删除工作底稿？', function(btn) {
					if(btn == 'yes') {
...
function inputComing() {
    ...
    var ds = new Ext.data.Store({
        ...
        reader : new Ext.data.JsonReader({
            totalProperty : 'totalProperty',
            root : 'root'
        }, ['id', 'filed1', 'filed2', 'filed3', 'filed5', 'filed11', 'filed12', 'filed13'])
    });
    ds.load({
        params : {
            aeinspectionNo : $("input[name='ino']").val(),
        ...
        callback : function(records, options, success) {
            ...
            if(records.length > 0){
                Ext.each(records, function(rec) {
                    ...
                    // Ext.Msg.alert('info', JSON.stringify(rec));
                    var recdata = rec.data;
                    Ext.getCmp('field1').setValue(recdata.filed1);
                    Ext.getCmp('field2').setValue(recdata.filed2);
                    Ext.getCmp('field3').setValue(recdata.filed3);
                    Ext.getCmp('field5').setValue(recdata.filed5);
                    Ext.getCmp('field11').setValue(recdata.filed11);
                    Ext.getCmp('field12').setValue(recdata.filed12);
                    Ext.getCmp('field13').setValue(recdata.filed13);
                    return false;
                });
            }
        }
...
function viewComingGrid() {
    ...
    var viewFiled5From = new Ext.form.FormPanel({//注意：Ext.form.FormPanel=Ext.FormPanel
        title : '<%= request.getAttribute("inputComing_title")%> 向被检查人告知的事项    ' + $("input[name='ino']").val(),
        width : 800,
        height : 250,
        // autoHeight:true,
        bodyStyle : 'padding:5px 5px 0',
...
function inputGoaway() {
    ...
    var ds = new Ext.data.Store({
        ...
        reader : new Ext.data.JsonReader({
            totalProperty : 'totalProperty',
            root : 'root'
        }, ['id', 'filed1', 'filed2', 'filed3', 'filed4', 'filed5', 'filed6', 'filed7', 'filed8', 'filed11', 'filed12'])
    });
    ds.load({
        params : {
            aeinspectionNo : $("input[name='ino']").val(),
        ...
        callback : function(records, options, success) {
            ...
            if(records.length > 0){
                Ext.each(records, function(rec) {
                    ...
                    Ext.getCmp('field2').setValue(recdata.filed2);
                    Ext.getCmp('field3').setValue(recdata.filed3);
                    Ext.getCmp('field4').setValue(recdata.filed4);
                    Ext.getCmp('field5').setValue(recdata.filed5);
                    Ext.getCmp('field6').setValue(recdata.filed6);
                    Ext.getCmp('field7').setValue(recdata.filed7);
                    Ext.getCmp('field8').setValue(recdata.filed8);
                    Ext.getCmp('field11').setValue(recdata.filed11);
                    Ext.getCmp('field12').setValue(recdata.filed12);
                    return false;
                });
...
function inputTalkSummary() {
    ...
    var ds = new Ext.data.Store({
        ...
        reader : new Ext.data.JsonReader({
            totalProperty : 'totalProperty',
            root : 'root'
        }, ['id', 'filed1', 'filed2', 'filed3', 'filed4', 'filed5', 'filed6', 'filed10', 'filed13', 'filed14', 'filed15'])
    });
    ds.load({
        params : {
            aeinspectionNo : $("input[name='ino']").val(),
        ...
        callback : function(records, options, success) {
            ...
            if(records.length > 0){
                Ext.each(records, function(rec) {
                    ...
                    Ext.getCmp('field5').setValue(recdata.filed5);
                    Ext.getCmp('field6').setValue(recdata.filed6);
                    Ext.getCmp('field10').setValue(recdata.filed10);
                    Ext.getCmp('field13').setValue(recdata.filed13);
                    Ext.getCmp('field14').setValue(recdata.filed14);
                    Ext.getCmp('field15').setValue(recdata.filed15);
                    return false;
                });
            }
        }
        ...
        var row7 = {
            ...
            items : [{
                ...
                items : [{
                    ...
                    // blankText : '必须选择检查方式',// 该项如果没有选择，则提示错误信息
...
function addFactBook() {
    if($("input[name='isSaveAeedorgSelect']").val() == 'false') {
        ...
        var ds = new Ext.data.Store({
            proxy : new Ext.data.HttpProxy({
                url : '<%=request.getContextPath()%>/AdminEnforceManagerAction.do?method=pageFactBook',
                method : 'POST',
                baseParams : {
                    aeinspectionNo : $("input[name='ino']").val(),
                    inspect_token : $("input[name='inspect_token']").val()
            ...
            reader : new Ext.data.JsonReader({
                totalProperty : 'totalProperty',
                root : 'root'
            }, ['id', 'filed5', 'filed6', 'filed9', 'filed12'])
        });
        ds.load({
            params : {
                aeinspectionNo : $("input[name='ino']").val(),
            ...
            callback : function(records, options, success) {
                ...
                if(records.length > 0){
                    Ext.each(records, function(rec) {
                        ...
                        // Ext.Msg.alert('info', JSON.stringify(rec));
                        var recdata = rec.data;
                        Ext.getCmp('factBookContent').setValue(recdata.filed5);
                        Ext.getCmp('filed6').setValue(recdata.filed6);
                        Ext.getCmp('filed9').setValue(recdata.filed9);
                        Ext.getCmp('filed12').setValue(recdata.filed12);
                        return false;
                    });
                }
            }
...
function validateForm(){
        ...
        isPass = false;
                ...
                if(isNullOrEmpty($("input[name='aemaster']").val())){
                    $('#aemaster_span').html(errorGif+'&nbsp;&nbsp;必填');
                    isPass=false;
                }else{
                    $('#aemaster_span').html(okGif);
                }
                if(isNullOrEmpty($("input[name='aeother']").val())){
	...
	<body>
		...
		<html:form
			action="/AdminEnforceManagerAction.do?method=updateAeinspection"
														...
														<td height="180" valign="top">
															<table width="100%" border="0" cellpadding="0"
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="prjnm" size="100%" value="<%= request.getAttribute("prjnm") %>" readonly="readonly">
																	</td>
																</tr>
																<tr>
																	<td align="right" class="tabletext02">
																	...
																	<td>
																		<html:text property="aeheadman"
																			 readonly="true" size="100%"></html:text>
																...
																<tr>
																	...
																	<td>
																		<html:text property="inrcdno" readonly="true"  size="100%"></html:text>
																	</td>
																</tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <html:text property="outrcdno" readonly="true" size="100%"></html:text>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right" class="tabletext02">
																...
																<tr>
																	...
																	<td>
																		<html:text property="actualrcdno" readonly="true"  size="100%"></html:text>
																	</td>
																</tr>
																<tr>
																	<td align="right" class="tabletext02">
																...
																<tr>
																	<td colspan="2" align="center">
																		<input type="button" value="保 存" class="botton01"
																			onclick="return updateAeinspection();" />
