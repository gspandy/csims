...
<html>
	<head>
	    ...
	    function create(){
			if(confirm("操作将录入机构诚信档案,确认?")){
				document.forms[0].action="ZxMarketMgrAction.do?method=createZxOrgIntegrityDocument";
	...
	<body>
		...
		<html:form action="/ZxMarketMgrAction.do?method=createZxOrgIntegrityDocument" method="post">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
