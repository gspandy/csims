...
public class ApplicationContextTest extends AbstractAnnotationAwareTransactionalTests {
    ...
    static {
        ...
        if (osName.indexOf("Windows") != -1) {
            ...
            WORKPATH = "file:E:\\workspacepbc\\csims\\WebContent\\WEB-INF\\conf/spring/";
            TEST_TEMPOTORY_PATH = "E:\\MyWorkSapces/TESTCASE_TEMP_DIR/";
        } else {
    ...
    protected String[] getConfigLocations() {
        ...
        return new String[] {
                ...
                WORKPATH + "applicationContext-serial-number.xml",
                WORKPATH + "applicationContext-schedule.xml"
