...
public class StringUtil {
	...
	private static final String[] DATE_FORMAT = { "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm:ss.S" };
	 ...
	 * @return
	 */
	public static String join(Object[] array, String prefix, String postfix, String separator) {
	 ...
	 * @return
	 */
	public static String convertEncode(String a, String oldEncode, String newEncode) {
		try {
	...
	public static String escapeFormatInfo(String srcStr) {
		if (StringUtils.isNotBlank(srcStr)) {
			return srcStr.replaceAll("</?[^>]+>", "").replaceAll("<a>\\s*|\t|\r|\n</a>", "").replace("&nbsp;", "");// 去除字符串中的空格,回车,换行符,制表符
		} else {
			return "";
		}
	}
