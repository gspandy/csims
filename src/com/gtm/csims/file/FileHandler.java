...
public interface FileHandler {
     ...
     * @param piVariables
     */
    public void save(ActionForm form, String webRealPath,
            Map<String, String[]> params, Map<String, Object> piVariables);
     ...
     * @param distFileName
     */
    public void save(byte[] fileData, String servletContextRealPath,
            String[] folderNames, String diskFileName);
     ...
     * @param distFileName
     */
    public void save(FormFile formFile, String servletContextRealPath,
            String[] folderNames, String distFileName);
     ...
     * @param distFileName
     */
    public void save(FormFile[] formFiles, String servletContextRealPath,
            String[] folderNames, String[] distFileName);
     ...
     *            目标zip文件路径
     */
    public void compress(String webRealPath, String[] srcFilePaths,
            String destFilePath, Map<String, String> scanMap);
     ...
     * @return
     */
    public String saveBsAttachment(String username, FormFile file,
            String realPath);
    ...
    public String saveBsAttachmentWithFileType(String username, FormFile file,
            String realPath);
     ...
     * @throws Exception
     */
    public void download(String attachId, HttpServletRequest request,
