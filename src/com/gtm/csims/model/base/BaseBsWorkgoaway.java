...
/**
 * This is an object that contains data related to the BS_WORKGOAWAY table.
...
public abstract class BaseBsWorkgoaway  implements Serializable {

	public static String REF = "BsWorkgoaway";
	 ...
	 */
	public BaseBsWorkgoaway (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.gtm.csims.model.BsWorkgoaway)) return false;
		else {
			com.gtm.csims.model.BsWorkgoaway bsWorkgoaway = (com.gtm.csims.model.BsWorkgoaway) obj;
			if (null == this.getId() || null == bsWorkgoaway.getId()) return false;
			else return (this.getId().equals(bsWorkgoaway.getId()));
		}
	}
