...
public abstract class BaseBsWorkcheck  implements Serializable {

	public static String REF = "BsWorkcheck";
	 ...
	 */
	public BaseBsWorkcheck (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.gtm.csims.model.BsWorkcheck)) return false;
		else {
			com.gtm.csims.model.BsWorkcheck bsWorkcheck = (com.gtm.csims.model.BsWorkcheck) obj;
			if (null == this.getId() || null == bsWorkcheck.getId()) return false;
			else return (this.getId().equals(bsWorkcheck.getId()));
		}
	}
