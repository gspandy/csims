 ...
 *
 * @hibernate.class
 *  table="BS_OrgRELEVANTINFO"
 */

public abstract class BaseBsOrgRelevantInfo  implements Serializable {

	public static String REF = "BsOrgRelevantInfo";
	 ...
	 */
	public BaseBsOrgRelevantInfo (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.gtm.csims.model.BsOrgRelevantInfo)) return false;
		else {
			com.gtm.csims.model.BsOrgRelevantInfo bs = (com.gtm.csims.model.BsOrgRelevantInfo) obj;
