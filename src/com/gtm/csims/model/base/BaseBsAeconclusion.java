...
public abstract class BaseBsAeconclusion implements Serializable {
     ...
     */
    public BaseBsAeconclusion(java.lang.String id, java.lang.String aeno, java.lang.String aeorgnm,
            java.lang.String aeorgno, java.lang.String aeedorgnm, java.lang.String aeedorgno,
    ...
    public boolean equals(Object obj) {
        if (null == obj)
            return false;
        if (!(obj instanceof com.gtm.csims.model.BsAeconclusion))
            return false;
        else {
            com.gtm.csims.model.BsAeconclusion bsAeconclusion = (com.gtm.csims.model.BsAeconclusion) obj;
            if (null == this.getId() || null == bsAeconclusion.getId())
                return false;
            else
                return (this.getId().equals(bsAeconclusion.getId()));
        }
    }
