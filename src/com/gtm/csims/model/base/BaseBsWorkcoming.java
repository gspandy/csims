...
/**
 * This is an object that contains data related to the BS_WORKCOMING table.
...
public abstract class BaseBsWorkcoming  implements Serializable {

	public static String REF = "BsWorkcoming";
	 ...
	 */
	public BaseBsWorkcoming (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.gtm.csims.model.BsWorkcoming)) return false;
		else {
			com.gtm.csims.model.BsWorkcoming bsWorkcoming = (com.gtm.csims.model.BsWorkcoming) obj;
			if (null == this.getId() || null == bsWorkcoming.getId()) return false;
			else return (this.getId().equals(bsWorkcoming.getId()));
		}
	}
