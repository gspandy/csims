...
public class EnforceService extends BaseEnforceService {
    ...
    private void validateAdmenforce(BsAdmenforce ae) {
        ...
        if (ae.getAecontent() != null && ae.getAecontent().length() > 250) {
            throw new IllegalArgumentException("检查内容超过允许长度250");
        }
    ...
    public Page queryAdmenforce(String aeNo, String aeorgName, String aeedorgName,
     ...
     */
    @Transactional(readOnly = true)
    public Page queryAdmenforceForInspc(String aeNo, String aeorgName, String aeedorgName,
            String aeplanstDate, String aeplantmDate, Integer pageNo, Integer pageSize, String orgNo) {
    ...
    public Boolean isUniqueAdmenforceNo(String admenForceNo) {
        List<BsAdmenforce> list = bsAdmenforceDao.find("from BsAdmenforce where aeno = ? ",
                admenForceNo);
     ...
     */
    @Transactional(readOnly = true)
    public Page queryAeinspection(String aeNo, String aeorgName, String aeedorgName,
            String aeplanstDate, String aeplantmDate, Integer pageNo, Integer pageSize, String orgNo) {
     ...
     */
    @Transactional(readOnly = true)
    public Page queryAeinspectionForCon(String aeNo, String aeorgName, String aeedorgName,
            String aeplanstDate, String aeplantmDate, Integer pageNo, Integer pageSize, String orgNo) {
     ...
     */
    @Transactional(readOnly = true)
    public Page queryAeinspectionForRefti(String aeNo, String aeorgName, String aeedorgName,
            String aeplanstDate, String aeplantmDate, Integer pageNo, Integer pageSize, String orgNo) {
    ...
    public Boolean isUniqueAeInspectionNo(String admenForceNo) {
        List<BsAeinspection> list = bsAeinspectionDao.find(
                "FROM BsAeinspection where aerecordno = ? ", admenForceNo);
        if (CollectionUtils.isNotEmpty(list)) {
            return false;
        } else {
            return true;
    ...
    public BsAeinspection getAeinspectionByIno(String ino) {
        ...
        List<BsAeinspection> list = bsAeinspectionDao.find("from BsAeinspection where ino = ? ",
                ino);
        if (CollectionUtils.isNotEmpty(list)) {
            return (BsAeinspection) list.get(0);
        }
     ...
     */
    @Transactional(readOnly = true)
    public Page queryAeconclusion(String aeNo, String aeorgName, String aeedorgName,
            String aeplanstDate, String aeplantmDate, Integer pageNo, Integer pageSize, String orgNo) {
     ...
     */
    @Transactional(readOnly = true)
    public Page queryAeconclusionWithPunish(String aeNo, String aeorgName, String aeedorgName,
            String aeplanstDate, String aeplantmDate, Integer pageNo, Integer pageSize, String orgNo) {
     ...
     */
    @Transactional(readOnly = true)
    public Page queryAeconclusionByBank(String aeNo, String aeOpnionNo, String aeorgName,
            String aeedorgName, String aeplanstDate, String aeplantmDate, Integer pageNo,
        ...
        if (StringUtils.isNotBlank(orgNo)) {
            //            String childrenNoStr = super.getChildOrgByParentNoStr(orgNo);
            //            if (StringUtils.isNotBlank(childrenNoStr)) {
            //                sb.append(" and ").append(this.getOrInClause("aeedorgno in (%s)", childrenNoStr));
            //            }
     ...
     */
    @Transactional(readOnly = true)
    public Page queryAeconclusionByPcb(String aeNo, String aeOpnionNo, String aeorgName,
            String aeedorgName, String aeplanstDate, String aeplantmDate, Integer pageNo,
            Integer pageSize, String orgNo) {
        if (orgNo == null || StringUtils.isBlank(orgNo)) {
            return null;
    ...
    public Boolean isUniqueAEConclusionNo(String admenForceNo) {
        List<BsAeconclusion> list = bsAeconclusionDao.find(
                "from BsAeconclusion where aeopnionno = ? ", admenForceNo);
        if (CollectionUtils.isNotEmpty(list)) {
            return false;
        } else {
            return true;
     ...
     */
    @Transactional(readOnly = true)
    public Page queryAerectification(String trackno, String aeorgName, String aeedorgName,
            String aeplanstDate, String aeplantmDate, Integer pageNo, Integer pageSize, String orgNo) {
        ...
        sb.append(" order by createdate desc");
        Page page = bsAerectificationDao.pagedQuery(sb.toString(), pageNo, pageSize,
                param.toArray());
        return page;
    ...
    public Boolean isUniqueAeRectificationNo(String admenForceNo) {
        List<BsAerectification> list = bsAerectificationDao.find(
                "from BsAerectification where trackno = ? ", admenForceNo);
        if (CollectionUtils.isNotEmpty(list)) {
            return false;
        } else {
            return true;
    ...
    public BsAerectification getAerectification(String id) {
        ...
        List<BsAerectification> list = bsAerectificationDao.find(
                "from BsAerectification where id = ? ", id);
        if (CollectionUtils.isNotEmpty(list)) {
    ...
    public BsAerectification getAerectificationByIno(String aeno) {
        ...
        List<BsAerectification> list = bsAerectificationDao.find(
                "from BsAerectification where aeno = ? ", aeno);
        if (CollectionUtils.isNotEmpty(list)) {
            return (BsAerectification) list.get(0);
        } else {
            return null;
    ...
    public Boolean hasWorkBasis(String aeinspectionNo, String inspectToken) {
        ...
        List<BsWorkbasis> list = bsWorkbasisDao.find(
                "from BsWorkbasis where filed7 = ? and stat = ?", aeinspectionNo, inspectToken);
    ...
    public Boolean isUniqueWorkBasisNo(String no) {
        List<BsAerectification> list = bsWorkbasisDao.find(
                "from BsAerectification where trackno = ? ", no);
        if (CollectionUtils.isNotEmpty(list)) {
            return false;
        } else {
            return true;
    ...
    public Boolean hasWorkcoming(String aeinspectionNo, String inspectToken) {
        ...
        List<BsWorkcoming> list = bsWorkcomingDao.find(
                "from BsWorkcoming where filed7 = ? and stat = ?", aeinspectionNo, inspectToken);
        return CollectionUtils.isNotEmpty(list);
    }
    ...
    public Page pageInspectionAnl(String aeinspectionNo, Integer pageNo, Integer pageSize) {
        ...
        sb.append(" order by createdate desc");
        Page page = bsAeinspectionAnlDao.pagedQuery(sb.toString(), pageNo, pageSize,
                param.toArray());
        return page;
    }
    ...
    public Boolean hasInspectionAnl(String aeinspectionNo, String inspectToken) {
        ...
        List<BsAeinspectionAnl> list = bsAeinspectionAnlDao.find(
                "from BsAeinspectionAnl where Aeinspectionno = ? and stat = ?", aeinspectionNo,
                inspectToken);
        return CollectionUtils.isNotEmpty(list);
    }
    ...
    public Boolean hasWorkgoaway(String aeinspectionNo, String inspectToken) {
        ...
        List<BsWorkgoaway> list = bsWorkgoawayDao.find(
                "from BsWorkgoaway where filed14 = ? and stat = ?", aeinspectionNo, inspectToken);
        return CollectionUtils.isNotEmpty(list);
    }
    ...
    public Page pageWorktalksummary(String aeinspectionNo, Integer pageNo, Integer pageSize) {
        ...
        sb.append(" order by createdate desc");
        Page page = bsWorktalksummaryDao.pagedQuery(sb.toString(), pageNo, pageSize,
                param.toArray());
        return page;
    }
    ...
    public Boolean hasWorktalksummary(String aeinspectionNo, String inspectToken) {
        ...
        List<BsWorktalksummary> list = bsWorktalksummaryDao.find(
                "from BsWorktalksummary where filed16 = ? and stat = ?", aeinspectionNo,
                inspectToken);
        return CollectionUtils.isNotEmpty(list);
    }
     ...
     */
    @Transactional(readOnly = true)
    public Page pageAeInspectionAnalyse(String a, String b, String stdate, String tmdate,
            Integer pageNo, Integer pageSize, String orgNo) {
        StringBuffer sb = new StringBuffer("from BsAeinspectionAnl where 1=1 ");
        List<Object> param = new ArrayList<Object>();
     ...
     */
    @Transactional(readOnly = false)
    public String saveFactBook(String aeNo, String inspectionNo, String titleOrg, String aeOrg,
            String aeedOrg, String factBookContent, String filed6, String filed12, String filed9,
            String selectedwtgk, String aeorgno, String aeorgnm, String aeedorgno,
            String aeedorgnm, String inspectToken) {
        ...
        if (fb == null) {
            ...
            if (bs == null) {
                ...
                String factBookNo = noGenerator.generateNoStr(bs.getFactnotext(),
                        bs.getFactnoyear(), String.valueOf(bs.getFactnoindex()));
     ...
     */
    @Transactional(readOnly = true)
    public Page pageFactBook(String aeinspectionNo, Integer pageNo, Integer pageSize,
            String inspectToken) {
    ...
    public BsFactbook getFactBook(String inspctionNo) {
        List<BsFactbook> fbs = this.bsFactbookDao.find(
                "from BsFactbook where Filed11 = ? order by Updateate", inspctionNo);
    ...
    public BsFactbook getFactBook(String inspctionNo, String inspectToken) {
        ...
        if (StringUtils.isNotBlank(inspectToken)) {
            fbs = this.bsFactbookDao.find(
                    "from BsFactbook where Filed11 = ? and Stat = ? order by Updateate",
                    inspctionNo, inspectToken);
        } else {
            fbs = this.bsFactbookDao.find("from BsFactbook where Filed11 = ? order by Updateate",
                    inspctionNo);
        }
        if (CollectionUtils.isNotEmpty(fbs)) {
            return fbs.get(0);
    ...
    public Boolean hasFactBook(String aeinspectionNo, String inspectToken) {
        ...
        List<BsFactbook> list = bsFactbookDao.find(
                "from BsFactbook where Filed11 = ? and stat = ?", aeinspectionNo, inspectToken);
        return CollectionUtils.isNotEmpty(list);
    }
    ...
    public BsWorkcoming getWorkcoming(String inspctionNo) {
        ...
        List<BsWorkcoming> fbs = this.bsWorkcomingDao.find(
                "from BsWorkcoming where Filed7 = ? order by Updateate", inspctionNo);
        if (CollectionUtils.isNotEmpty(fbs)) {
            return fbs.get(0);
        } else {
            return null;
    ...
    public BsWorkcoming getWorkcoming(String inspctionNo, String inspectToken) {
        ...
        if (StringUtils.isNotBlank(inspectToken)) {
            fbs = this.bsWorkcomingDao.find(
                    "from BsWorkcoming where Filed7 = ? and stat = ? order by Updateate",
                    inspctionNo, inspectToken);
        } else {
            fbs = this.bsWorkcomingDao.find(
                    "from BsWorkcoming where Filed7 = ? order by Updateate", inspctionNo);
    ...
    public BsWorkgoaway getWorkgoaway(String inspctionNo) {
        ...
        List<BsWorkgoaway> fbs = this.bsWorkgoawayDao.find(
                "from BsWorkgoaway where Filed14 = ? order by Updateate", inspctionNo);
        if (CollectionUtils.isNotEmpty(fbs)) {
            return fbs.get(0);
        } else {
            return null;
    ...
    public BsWorkgoaway getWorkgoaway(String inspctionNo, String inspectToken) {
        ...
        if (StringUtils.isNotBlank(inspectToken)) {
            fbs = this.bsWorkgoawayDao.find(
                    "from BsWorkgoaway where Filed14 = ? and stat = ? order by Updateate",
                    inspctionNo, inspectToken);
        } else {
            fbs = this.bsWorkgoawayDao.find(
                    "from BsWorkgoaway where Filed14 = ? order by Updateate", inspctionNo);
    ...
    public BsAeinspectionAnl getInspectionAnl(String inspctionNo, String inspectToken) {
        ...
        if (StringUtils.isNotBlank(inspectToken)) {
            fbs = this.bsAeinspectionAnlDao
                    .find("from BsAeinspectionAnl where aeinspectionno = ? and stat = ? order by Updateate",
                            inspctionNo, inspectToken);
        } else {
            fbs = this.bsAeinspectionAnlDao.find(
                    "from BsAeinspectionAnl where aeinspectionno = ? order by Updateate",
                    inspctionNo);
        }
        if (CollectionUtils.isNotEmpty(fbs)) {
            return fbs.get(0);
    ...
    public BsWorktalksummary getWorktalksummary(String inspctionNo, String inspectToken) {
        ...
        if (StringUtils.isNotBlank(inspectToken)) {
            fbs = this.bsWorkcomingDao.find(
                    "from BsWorktalksummary where Filed16 = ? and stat = ? order by Updateate",
                    inspctionNo, inspectToken);
        } else {
            fbs = this.bsWorktalksummaryDao.find(
                    "from BsWorktalksummary where Filed16 = ? order by Updateate", inspctionNo);
        }
        if (CollectionUtils.isNotEmpty(fbs)) {
            return fbs.get(0);
    ...
    public BsAdmenforce getAdminEnforce(String aeNo) {
        ...
        List<BsAdmenforce> fbs = this.bsAdmenforceDao.find(
                "from BsAdmenforce where Aeno = ? order by Updatedate", aeNo);
        if (CollectionUtils.isNotEmpty(fbs)) {
            return fbs.get(0);
        } else {
            return null;
    ...
    public void clearUselessAeinspRelative() {
        ...
        try {
            remindService.writeLog(sb.toString(), StringUtils.EMPTY, StringUtils.EMPTY, "HTTP",
                    "系统自动");
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     */
    @Transactional(readOnly = true)
    public Page pageDctionarys(String type, String dkey, String dvalue, String dsumry,
     ...
     */
    @Transactional(readOnly = false)
    public void saveDctionary(String id, String type, String dkey, String dvalue, String dsumry,
            String stat, String flag, String isenable) throws Exception {
        BsDictionary dc = null;
        Date date = new Date();
        if (StringUtils.isBlank(id)) {
            List<BsDictionary> dcs = bsDictionaryDao.find("from BsDictionary where dkey = ? ",
                    new Object[] { dkey });
    ...
    public String getParentDataStr() {
        ...
        List<BsDictionary> dcs = bsDictionaryDao
                .find("from BsDictionary where flag = 'false' and stat='000011' ");
        if (dcs != null && dcs.size() > 0) {
            for (Iterator<BsDictionary> iterator = dcs.iterator(); iterator.hasNext();) {
                ...
                if (bsDictionary != null) {
                    sb.append(",['").append(bsDictionary.getId()).append("','")
                            .append(bsDictionary.getDvalue()).append("']");
                }
            }
        }
        sb.append("]");
