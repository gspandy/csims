...
public class SelectSystemDataBaseByDwr {
	...
	public String[] getAepeople(String orgno, String deptno) {
		...
		// }
		String[] result = new String[3];
		result[0] = "51082419851031575X" + "-" + "閭辨磱";
		result[1] = "N02" + "-" + "鏉庡洓";
		result[2] = "N03" + "-" + "鐜嬩簲";
		return result;
	}
	...
	public String getUserCheckboxByOrgNo(String orgNo) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			sb.append("<input type='checkbox' name='userCheckbox' value='").append(bs.getName()).append("' />")
			        .append(bs.getName()).append("<br>");
		}
		sb.append("</td>");
		return sb.toString();
	}
