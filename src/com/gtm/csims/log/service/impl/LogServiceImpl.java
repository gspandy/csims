...
public class LogServiceImpl implements LogService {
	 ...
	 */
	@Transactional(readOnly = true)
	public Page findLog4jList(String loginUserNickName, String message, String begin, String end, String priority,
	        int pageNo, int pageSize) {
		StringBuffer sb = new StringBuffer("From BsLog where 1=1 ");
		List<Object> param = new ArrayList<Object>();
		if (!"admin".equals(loginUserNickName)) {
			sb.append(" and Processer = '" + loginUserNickName + "' ");
	...
	public List getAboveGoodLogs() {
		...
		this.jsr94template.executeStateless(LOGS_RULE_URI, null, new StatelessRuleSessionCallback() {
